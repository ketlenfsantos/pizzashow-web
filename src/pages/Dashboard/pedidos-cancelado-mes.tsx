...
export function PedidosCanceladosMes() {
    ...
    return (
        <Card>
            ...
            {monthCanceledOrdersAmount ? (
                    <>
                    <span className=" text-2xl font-bold tracking-tight"> {monthCanceledOrdersAmount.amount.toLocaleString('pt-BR')}
                    </span>
  ...
  <span className=" text-emerald-400 dark:text-emerald-400"> {monthCanceledOrdersAmount.diffFromLastMonth}% </span> em relação a ontem
  </>
